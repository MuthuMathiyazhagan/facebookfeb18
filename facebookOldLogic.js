...
playTest = async(url, searchString, postGroup, username, password) => {
    ...
    // Below commented code will use sometimes . Please note: its still under development.
    ...
    //   await autoScroll(page); // For scoll the search result page till the bottom . To See all the group . Some common group may have 1000 counts
    ...
    // console.log("Text:\n", groupDetails[0]);
    // let match = /[0-9]{1,4}\S/.exec("one two 100"); // Ignore

    let uniqueGroupName = [...new Set(GroupName)]; // Remove duplicate group name
